          ...
          <AnimatePresence mode="wait">
            {!user ? (
              ...
              >
                ...
                <button
                  onClick={login}
                  className="px-10 py-5 bg-blue-600 text-white rounded-2xl font-black text-xl shadow-[0_20px_50px_rgba(37,99,235,0.3)] flex items-center gap-4 hover:scale-105 transition-all"
                >
